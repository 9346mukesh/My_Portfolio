...
const Skills = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      skills: ["Power BI", "DAX", "Excel", "Data Modeling", "KPI Analysis"]
    },
    {
    ...
    },
    {
      ...
      skills: ["DSA", "DBMS", "Computer Networks", "OOPs", "Operating Systems"]
    },
    {
      name: "Soft Skills",
      skills: [
        ...
        >
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-muted">
              Let's discuss how my data analytics skills can help your project.
            </p>
          </div>
